#!/usr/bin/env python3
"""Generate the complete Z-Image Fuli pipeline notebook."""
import json, uuid, os
...
C.append(code(
    ...
    "PARQUET_FILE = 'fuliji_dataset.parquet'\n"
    "\n"
...
C.append(code(
    ...
    "PROMPT   = 'portrait of \u840c\u82bd\u513fo0, soft studio lighting, high detail, 4k'  # <- edit me\n"
    ...
    "plt.tight_layout()\n"
    "plt.savefig('/tmp/section1_gallery.png', bbox_inches='tight', dpi=120)\n"
    "plt.show()"
))
...
C.append(code(
    ...
    "              fontsize=12, y=1.01)\n"
    "plt.tight_layout()\n"
    "plt.savefig('/tmp/section2_consistency.png', bbox_inches='tight', dpi=130)\n"
    "plt.show()"
))
...
C.append(code(
    ...
    "            plt.tight_layout()\n"
    "            plt.savefig(str(OUTPUT_DIR / 'live_loss.png'), bbox_inches='tight', dpi=100)\n"
...
C.append(code(
    ...
    "plt.tight_layout()\n"
    "plt.savefig(str(OUTPUT_DIR / 'final_loss.png'), bbox_inches='tight', dpi=140)\n"
    "plt.show()\n"
...
C.append(code(
    ...
    "    cap = build_caption(artist, ft, it)\n"
    "\n"
    "    ref_img = sq(Image.open(io.BytesIO(row0['image']['bytes'])).convert('RGB'), CELL_S)\n"
    "\n"
    ...
    "    print(f'  Saved: {out_p}')\n"
    "\n"
    "# Display all panels inline (preserved in notebook output)\n"
    "for pp in panels_saved:\n"
    "    img = Image.open(str(pp))\n"
    "    fig, ax = plt.subplots(figsize=(14, img.height / img.width * 14))\n"
    "    ax.imshow(img); ax.axis('off')\n"
    "    ax.set_title(pp.name, fontsize=9)\n"
    "    plt.tight_layout(); plt.savefig(str(pp), dpi=140, bbox_inches='tight'); plt.show()\n"
...
C.append(code(
    ...
    "\n"
    "plt.savefig(str(QUANT_DIR / 'quant_comparison.png'), bbox_inches='tight', dpi=140)\n"
    "plt.show()\n"
